...
def test_extract_monitor_data():
    ...
    data = nexus.extract_signal_data_array(nexus.types.AnyRunAnyNeXusMonitor(monitor))
...
def test_extract_detector_data_requires_unique_dense_data():
    ...
    with pytest.raises(
        ...
        nexus.extract_signal_data_array(nexus.types.AnyRunNeXusDetector(detector))
